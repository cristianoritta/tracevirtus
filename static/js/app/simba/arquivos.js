$('.delete-arquivo-cooperacao').click(function (event) {
    ...
    Swal.fire({
        title: 'Tem certeza?',
        text: "Você tem certeza que deseja excluir este arquivo e todos os seus registros?",
        icon: 'warning',
        ...
        if (result.isConfirmed) {
            ...
            document.body.addEventListener('htmx:afterRequest', function (event) {
                ...
                try {
                    ...
                    Swal.fire({
                        title: 'Erro!',
                        text: 'Não foi possível excluir a cooperação.',
                        icon: 'error',
                        confirmButtonText: 'OK'
                    });
                }
